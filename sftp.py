...
def upload_file(fpath):
	os.system("sshpass -p 'password' scp %s Brutalocalypse@192.168.137.1:Desktop/ " % fpath) # Desktop connection

	# ssh config appears to have been reset to default and lacking shorthand "brutal"
